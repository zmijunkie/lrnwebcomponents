...
class RpgCharacter extends SimpleColors {
  ...
  randomColor() {
    return Object.keys(this.colors)[
      Math.floor(Math.random() * Object.keys(this.colors).length)
    ];
  }
      ...
      <style>
        #hat {
          background-color: var(
            --simple-colors-default-theme-${this.hatColor}-6,
            orange
          );
        }
        #face {
          background-color: var(
            --simple-colors-default-theme-${this.faceColor}-3,
            blue
          );
        }
        #shirt {
          background-color: var(
            --simple-colors-default-theme-${this.shirtColor}-8,
            purple
          );
        }
        #pants {
          background-color: var(
            --simple-colors-default-theme-${this.pantsColor}-10,
            yellow
          );
        }
      </style>
